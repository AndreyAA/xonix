...
public class ScoreCalculator {
    ...
    int calcScore(double prevProgress, double currentProgress, State state) {
        ...
        double complexity = state.getCurLevel().itemInField * Math.pow(state.getCurLevel().velocityInField, 4);
        // 1%  + itemsInFiel =5 ->  1000
//        int itemBonus = (int) (state.getCurLevel().itemInField * delta * 1000);
//        int velocityBonus = (int) (state.getCurLevel().velocityInField * 5 * delta * 1000);
//        int timeBonus = (int)((10000.0 / time) * delta * 10000);
